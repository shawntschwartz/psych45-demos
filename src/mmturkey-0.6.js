...
(function () {
  ...
  function getKeys(obj) {
    ...
    for (var key in obj) {
      if (
        (hopUndefined || obj.hasOwnProperty(key)) &&
  ...
  var htmlifyTable = function (array) {
    ...
    var str = "";
    str +=
      "<span title='tabular representation of array of objects with the same set of keys'>";
    str +=
  ...
  turk.submit = function (object, unwrap) {
    ...
    if (typeof object == "undefined" || keys.length == 0) {
      alert(
        "mmturkey: you need to pass an object (i.e., actual data) to turk.submit() ",
      );
      return;
    }
    ...
    if (!assignmentId || !turkSubmitTo) {
      ...
      div.innerHTML =
        '<p><b>Submit the following on this <a href="https://docs.google.com/forms/d/e/1FAIpQLSc7J9lDqht9fS1Y9tLHncePLUGo99mLi27B-NgibiIiRSFDdA/viewform" target="_blank">Google Form:</a></b></p><ul><p><b><u>This list:</u></b></p><li style="word-wrap: break-word;">' +
        htmlify(rawData.data.thisList) +
        '</li><p><b><u>These results</u></b></p><li style="word-wrap: break-word;">' +
        htmlify(rawData.data.theseResults) +
        "</li></ul><p><b>Make sure to also submit your responses to the questions posted on the MiA 5 section of the course website to the assignment on Canvas!</b></p>";
