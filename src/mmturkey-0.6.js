...
(function() {
  ...
  turk.submit = function(object, unwrap) {
    ...
    if (!assignmentId || !turkSubmitTo) {
      ...
      div.innerHTML = '<p><b>Submit the following on this <a href="https://docs.google.com/forms/d/e/1FAIpQLSeRODUjfXMlluJXC99nOrb5pccIVmrh63w-0xI9SRzXwHU11A/viewform?usp=sf_link" target="_blank">Google Form:</a></b></p><ul><p><b><u>This list:</u></b></p><li style="word-wrap: break-word;">'+ htmlify(rawData.data.thisList) +'</li><p><b><u>These results</u></b></p><li style="word-wrap: break-word;">'+ htmlify(rawData.data.theseResults) +'</li></ul><p><b>Make sure to also submit your responses to the questions posted on the MiA 4 section of the course website to the assignment on Canvas!</b></p>';
